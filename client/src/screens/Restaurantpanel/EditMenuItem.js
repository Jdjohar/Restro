...
export default function EditMenuItem() {
    ...
    //     try {
    //         const response = await fetch(`https://real-estate-1kn6.onrender.com/api/menu/${menuItemId}`);
    //         const json = await response.json();
    ...
    const fetchMenuData = async () => {
        try {
            const response = await fetch(`https://real-estate-1kn6.onrender.com/api/getmenu/${menuItemId}`);
            const json = await response.json();
