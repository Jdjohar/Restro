...
export default function ResetPassword() {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const response = await fetch('https://real-estate-1kn6.onrender.com/api/reset-password', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className='py-3 pt-5'>
        <section className='d-flex justify-content-center align-items-center pt-5'>
            <div className='signin-form loginbox p-5 pb-4 mt-3 forgotpassword'>
                ...
                <div class="d-flex justify-content-center">
                    <button class="form-control w-75 btn btn-primary btnblur mb-1" onClick={handleResetPassword}>Reset Password</button>
                </div>
